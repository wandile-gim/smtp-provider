...
// QueryTenant queries the tenant edge of a Configuration.
func (c *ConfigurationClient) QueryTenant(co *Configuration) *TenantQuery {
...
// QueryConfigurations queries the configurations edge of a Tenant.
func (c *TenantClient) QueryConfigurations(t *Tenant) *ConfigurationQuery {
...
type (
	hooks struct {
		Configuration, Tenant []ent.Hook
	}
	inters struct {
		Configuration, Tenant []ent.Interceptor
	}
)
